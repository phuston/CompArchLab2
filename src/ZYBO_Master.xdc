...
##Switches
##IO_L19N_T3_VREF_35
set_property PACKAGE_PIN G15 [get_ports {sclk_pin}]
set_property IOSTANDARD LVCMOS33 [get_ports {sclk_pin}]

##IO_L24P_T3_34
set_property PACKAGE_PIN P15 [get_ports {cs_pin}]
set_property IOSTANDARD LVCMOS33 [get_ports {cs_pin}]

##IO_L4N_T0_34
set_property PACKAGE_PIN W13 [get_ports {mosi_pin}]
set_property IOSTANDARD LVCMOS33 [get_ports {mosi_pin}]

##IO_L9P_T1_DQS_34
set_property PACKAGE_PIN T16 [get_ports {fault_pin}]
set_property IOSTANDARD LVCMOS33 [get_ports {fault_pin}]
...
set_property PACKAGE_PIN D18 [get_ports {miso_pin}]
set_property IOSTANDARD LVCMOS33 [get_ports {miso_pin}]
